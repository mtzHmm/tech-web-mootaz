...
// Ce fichier démontre l'utilisation des modules TypeScript

// Import de types seulement
import type { MathOperation, Calculator } from './types.js';
...
const operation: MathOperation = (a: number, b: number) => a ** b; // Puissance
...
export type { MathOperation, Calculator };